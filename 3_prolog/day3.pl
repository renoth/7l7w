...
nice_print([]).
nice_print([H|T]) :- print_row(H), write('|'), nl, nice_print(T).
...
nice_print([Row1, Row2, Row3, Row4, Row5, Row6, Row7, Row8, Row9]).
...
7,5,_,4,6,_,2,_,_,
2,_,4,_,_,5,8,6,_,
_,6,_,_,2,8,_,_,5], Sdk).

sudoku([4,8,7,_,5,_,_,6,_,
9,_,_,4,2,_,_,_,3,
2,_,6,_,8,9,5,_,_,
_,_,4,_,1,5,6,_,_,
1,_,_,_,_,4,_,5,_,
